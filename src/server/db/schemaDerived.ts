...
import { user, post, admin } from './schema';;;;;; // Adjusted import path
...
export const collections = {
  ...
  admin: dbInstance.model('Admin', zodSchema(admin, sharedOptions)),
...
export const AdminCreateSchema = admin.omit({ _id: true, createdAt: true, updatedAt: true });
export const AdminUpdateSchema = admin.partial().omit({ _id: true, createdAt: true, updatedAt: true });
